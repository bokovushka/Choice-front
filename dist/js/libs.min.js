...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_libs_with_lib_svelte_range_slider_pips_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/libs/with-lib-svelte-range-slider-pips.js */ \"./src/js/modules/libs/with-lib-svelte-range-slider-pips.js\");\n/* harmony import */ var _modules_libs_with_lib_select2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/libs/with-lib-select2.js */ \"./src/js/modules/libs/with-lib-select2.js\");\n/* harmony import */ var _modules_libs_with_lib_floating_ui_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/libs/with-lib-floating-ui.js */ \"./src/js/modules/libs/with-lib-floating-ui.js\");\n//libs\n\n\n\n\n\n//# sourceURL=webpack://ulf/./src/js/libs.js?");

/***/ }),

/***/ "./src/js/modules/libs/with-lib-floating-ui.js":
/*!*****************************************************!*\
  !*** ./src/js/modules/libs/with-lib-floating-ui.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var _node_modules_select2_dist_js_select2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../node_modules/select2/dist/js/select2.js */ \"./node_modules/select2/dist/js/select2.js\");\n\n\n\n//? select\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\tjquery__WEBPACK_IMPORTED_MODULE_0__('.field .select-wrap select').select2({\n\t\tminimumResultsForSearch: -1,\n\t});\n});\n\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\tjquery__WEBPACK_IMPORTED_MODULE_0__('.select-city-value').select2({\n\t\tminimumResultsForSearch: -1,\n\t\tplaceholder: \"Ваше місто\",\n\t\tdropdownParent: jquery__WEBPACK_IMPORTED_MODULE_0__('.select-city__wrap')\n\t});\n});\n\njquery__WEBPACK_IMPORTED_MODULE_0__('.select-city-value').on('select2:select', function (e) {\n\tjquery__WEBPACK_IMPORTED_MODULE_0__('.choose-delivery-wrap').addClass('is-open');\n});\n\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\n\t// init select2 для всіх\n\tjquery__WEBPACK_IMPORTED_MODULE_0__('.select-post-office').each(function () {\n\t\tconst $select = jquery__WEBPACK_IMPORTED_MODULE_0__(this);\n\t\tconst $wrap = $select.closest('.select-post-office__wrap');\n\n\t\t$select.select2({\n\t\t\tminimumResultsForSearch: -1,\n\t\t\tplaceholder: \"Вибрати поштове відділення\",\n\t\t\tdropdownParent: $wrap\n\t\t});\n\t});\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__('input[name=\"checkbox-group-1\"]').on('change', function () {\n\n\t\tconst $option = jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('.delivery-option');\n\n\t\t// зняти активність з усіх\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__('.delivery-option').removeClass('is-active');\n\n\t\t// активувати тільки цей\n\t\t$option.addClass('is-active');\n\t});\n\n});\n\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__('.payment__option').each(function () {\n\n\t\tconst $option = jquery__WEBPACK_IMPORTED_MODULE_0__(this);\n\t\tconst $select = $option.find('.select-payment-method-value');\n\n\t\tif (!$select.length) return;\n\n\t\tconst $wrap = $select.closest('.select-payment-method__wrap');\n\n\t\t$select.select2({\n\t\t\tminimumResultsForSearch: -1,\n\t\t\tplaceholder: \"Ваше місто\",\n\t\t\tdropdownParent: $wrap\n\t\t});\n\n\t});\n\n});\n\n\n//# sourceURL=webpack://ulf/./src/js/modules/libs/with-lib-select2.js?");

/***/ }),

/***/ "./src/js/modules/libs/with-lib-svelte-range-slider-pips.js":
/*!******************************************************************!*\
  !*** ./src/js/modules/libs/with-lib-svelte-range-slider-pips.js ***!
  \******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _node_modules_svelte_range_slider_pips_dist_svelte_range_slider_pips_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../node_modules/svelte-range-slider-pips/dist/svelte-range-slider-pips.mjs */ \"./node_modules/svelte-range-slider-pips/dist/svelte-range-slider-pips.mjs\");\n\n\ndocument.addEventListener(\"DOMContentLoaded\", () => {\n\n\tif (!document.querySelector(\"#price-slider-full\")) return;\n\n\tfunction initPriceSlider({\n\t\tsliderId,\n\t\toutputSelector,\n\t\tmin = 0,\n\t\tmax = 10000,\n\t\tstart = 5000,\n\t\tsuffix = \" грн\",\n\t\tformat = (v) => v\n\t}) {\n\t\tconst sliderEl = document.getElementById(sliderId);\n\t\tconst output = document.querySelector(outputSelector);\n\n\t\tif (!sliderEl || !output) return;\n\n\t\tconst slider = new _node_modules_svelte_range_slider_pips_dist_svelte_range_slider_pips_mjs__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n\t\t\ttarget: sliderEl,\n\t\t\tprops: {\n\t\t\t\tmin,\n\t\t\t\tmax,\n\t\t\t\tvalue: start,\n\t\t\t\tstep: 1,\n\t\t\t\trange: \"min\",\n\t\t\t\tfloat: true,\n\t\t\t}\n\t\t});\n\n\t\tfunction update(value) {\n\t\t\toutput.innerHTML = `\n\t\t\t\t<span class=\"slider-value__number\">${format(value)}</span>\n\t\t\t`;\n\t\t}\n\n\t\tupdate(start);\n\n\t\tslider.$on(\"change\", (e) => {\n\t\t\tupdate(e.detail.value);\n\t\t});\n\t}\n\n\tinitPriceSlider({\n\t\tsliderId: \"price-slider-full\",\n\t\toutputSelector: \".slider-value\",\n\t\tmin: 0,\n\t\tmax: 682,\n\t\tstart: 206\n\t});\n});\n\n//# sourceURL=webpack://ulf/./src/js/modules/libs/with-lib-svelte-range-slider-pips.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/libs.js");
/******/ 	
/******/ })()
;